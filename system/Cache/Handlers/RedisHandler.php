...
class RedisHandler extends BaseHandler
{
    ...
    public function initialize()
    {
        ...
        try {
            ...
            if (isset($config['password']) && isset($config['username']) && !$this->redis->auth([$config['username'], $config['password']])) {
                log_message('error', 'Cache: Redis authentication using username and password failed.');
